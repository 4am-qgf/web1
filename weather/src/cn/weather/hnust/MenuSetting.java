...
public class MenuSetting {
	...
	public static String appId = "wx3014df40472ac466";
    public static String appSecret= "a955966abc171ec5e398ed2544373962"; 
    ...
    public static void add() throws JSONException{
        ...
        String json = "{"
                ...
                + "\"type\":\"view\","
                + "\"name\":\"开始答题\","
                + "\"url\":\"http://xfyecb.natappfree.cc/weather/qa.html\""
                + "}]"
        		+ "},"
        		+ "{"
        		+ "\"name\":\"我的排名\","
